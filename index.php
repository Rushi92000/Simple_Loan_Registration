...
<form id="form" name="RegForm" onsubmit="return validation()" action="confirm.php" method="post">
...
<input name="submit" type="submit" value="Submit" style="background-color: green;
 ...
 function validation(){
	...
	if(!email.match(vemail)){
	 ...
	 if(!pan.match(patt)){
		 document.getElementById('pan2').innerHTML="Invalid Pan Number Please Enter Valid mail id";
		 return false;
	 }
	 if(amt==""){
